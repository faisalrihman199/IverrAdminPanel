...
const Toggle = () => {
  ...
  return (
    <svg
      onMouseEnter={() => setFillColor('#7B2BFF')}
      onMouseLeave={() => setFillColor('#fff')}
      width="20"
      height="20"
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7 13C4.79086 13 3 14.7909 3 17C3 19.2091 4.79086 21 7 21C9.20914 21 11 19.2091 11 17C11 14.7909 9.20914 13 7 13ZM5 17C5 15.8954 5.89543 15 7 15C8.10457 15 9 15.8954 9 17C9 18.1046 8.10457 19 7 19C5.89543 19 5 18.1046 5 17Z"
        fill={fillColor}
      ></path>
    </svg>
  );
