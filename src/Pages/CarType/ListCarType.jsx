...
const ListCarType = () => {
    ...
    const headers = [
        ...
        { key: 'title', label: 'Car Type Title', isImage: false, sortable: true },
        { key: 'image', label: 'Car Type Image', isImage: true, sortable: false }
    ]
    ...
    return (
        <MainLayout>
            <section>
                <h1 className={`font-semibold mb-4 ${theme == 'dark' ? 'text-white' : 'color-2b'}`} style={{ fontSize: '24px' }}>Car Type List Management
                </h1>
